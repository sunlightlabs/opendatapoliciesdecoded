...
$body = '
	...
	This is the basic data about every policy, one JSON file per policy. Fields include section/jurisction, catch
	...
	This is the basic data about every policy, one plain text file per law. 

	<h2>Dictionary as JSON</h2>
	<p><a href="current/dictionary.json.zip">dictionary.json.zip</a><br />
	All terms defined in the policy, with each term’s definition, the section in which it is defined,
